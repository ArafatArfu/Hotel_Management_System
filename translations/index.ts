export const translations = {
  ...
  dashboard: {
    ...
    itemCount: { en: 'Item Count', ar: 'عدد العناصر', es: 'Nº de Artículos', fr: "Nb d'articles", bn: 'আইটেম সংখ্যা' },
  ...
  reports: {
    title: { en: 'Financial Reports', ar: 'التقارير المالية', es: 'Informes Financieros', fr: 'Rapports Financiers', bn: 'আর্থিক প্রতিবেদন' },
    totalRevenue: { en: 'Total Revenue (Month)', ar: 'إجمالي الإيرادات (شهري)', es: 'Ingresos Totales (Mes)', fr: 'Revenu Total (Mois)', bn: 'মোট রাজস্ব (মাস)' },
    totalExpenses: { en: 'Total Expenses (Month)', ar: 'إجمالي المصروفات (شهري)', es: 'Gastos Totales (Mes)', fr: 'Dépenses Totales (Mois)', bn: 'মোট খরচ (মাস)' },
    netProfit: { en: 'Net Profit (Month)', ar: 'صافي الربح (شهري)', es: 'Ganancia Neta (Mes)', fr: 'Bénéfice Net (Mois)', bn: 'নিট লাভ (মাস)' },
    yearlySales: { en: "This Year's Sales", ar: 'مبيعات هذا العام', es: 'Ventas de este Año', fr: 'Ventes de cette année', bn: 'এই বছরের বিক্রয়' },
