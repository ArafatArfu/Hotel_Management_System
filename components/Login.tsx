    ...
    <div className="flex items-center justify-center min-h-screen bg-brand-bg dark:bg-brand-bg-dark">
      <div className="w-full max-w-md p-8 space-y-6 bg-brand-surface dark:bg-brand-surface-dark rounded-lg shadow-md">
        <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">Admin & Staff Login</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label htmlFor="username" className="text-sm font-bold text-gray-700 dark:text-gray-300 tracking-wide">Username</label>
            <input
              id="username"
              type="text"
              value={username}
          ...
          <div>
            <label htmlFor="password"  className="text-sm font-bold text-gray-700 dark:text-gray-300 tracking-wide">Password</label>
            <input
              id="password"
              type="password"
              value={password}
