...
const Dashboard: React.FC<DashboardProps> = ({ orders, isAdmin, onDeleteOrder }) => {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-3xl font-bold text-brand-primary font-serif">Today's Dashboard</h2>
      ...
      <div className="bg-brand-surface p-6 rounded-lg shadow-md">
        <h3 className="text-xl font-bold text-brand-primary font-serif mb-4">Order History</h3>
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="border-b-2 border-gray-200">
              <tr>
                <th className="py-2 px-4 text-gray-600 font-medium">Receipt No</th>
