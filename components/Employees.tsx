  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white dark:bg-brand-surface-dark p-6 rounded-lg shadow-xl w-full max-w-md">
        <h2 className="text-2xl font-bold mb-4 dark:text-gray-100">{employee ? 'Edit Employee' : 'Add New Employee'}</h2>
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-3xl font-bold text-brand-primary dark:text-gray-100 font-serif">Employee Management</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead className="border-b-2 border-gray-200 dark:border-gray-700">
              <tr>
                <th className="py-2 px-4 text-gray-600 dark:text-gray-400 font-medium">Name</th>
                <th className="py-2 px-4 text-gray-600 dark:text-gray-400 font-medium">Role</th>
                <th className="py-2 px-4 text-gray-600 dark:text-gray-400 font-medium">Salary</th>
                <th className="py-2 px-4 text-gray-600 dark:text-gray-400 font-medium">Status</th>
              ...
              {filteredEmployees.length > 0 ? (
                filteredEmployees.map(employee => (
                  <tr key={employee.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50">
                    ...
                    <td className="py-3 px-4 text-gray-800 dark:text-gray-200">৳{employee.salary.toLocaleString()} / {employee.salaryType}</td>
